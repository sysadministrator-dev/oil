  ...
  return (
    <section className="relative h-screen w-full flex items-center justify-center overflow-hidden bg-white">
      ...
      <div className="container mx-auto px-10 relative z-10">
        <div className="max-w-6xl mx-auto text-center flex flex-col items-center">
          <div className="inline-flex items-center gap-3 px-6 py-2 bg-slate-50 border border-slate-100 rounded-full mb-12 animate-fade-in-up">
            ...
            <span className="text-[10px] font-black uppercase tracking-[0.3em] text-slate-400">Molecular Engine Protection</span>
          </div>
          ...
          <p className="text-lg md:text-xl text-slate-400 mb-20 max-w-2xl mx-auto leading-relaxed font-medium tracking-tight animate-fade-in-up [animation-delay:200ms]">
            Архитектура абсолютной защиты. <br />
            Исключительные масла для двигателей нового поколения.
          </p>
          ...
          <div className="flex flex-wrap items-center justify-center gap-16 animate-fade-in-up [animation-delay:400ms]">
            <div className="flex flex-col items-center gap-4 group cursor-help">
              ...
              <span className="text-[9px] font-black uppercase tracking-[0.2em] text-slate-400">High-Tech Labs</span>
            </div>
            <div className="flex flex-col items-center gap-4 group cursor-help">
              <div className="w-12 h-12 rounded-full border border-slate-100 flex items-center justify-center bg-white shadow-sm transition-transform duration-500 group-hover:scale-110">
                <Zap className="w-5 h-5 text-slate-950" />
              </div>
              <span className="text-[9px] font-black uppercase tracking-[0.2em] text-slate-400">Peak Performance</span>
            </div>
            <div className="flex flex-col items-center gap-4 group cursor-help">
              <div className="w-12 h-12 rounded-full border border-slate-100 flex items-center justify-center bg-white shadow-sm transition-transform duration-500 group-hover:scale-110">
                <Award className="w-5 h-5 text-slate-950" />
              </div>
              <span className="text-[9px] font-black uppercase tracking-[0.2em] text-slate-400">Engine Health</span>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="absolute bottom-12 left-1/2 -translate-x-1/2 flex flex-col items-center gap-4 opacity-30">
        <span className="text-[9px] font-black uppercase tracking-[0.3em] text-slate-950">Engineering Mastery</span>
